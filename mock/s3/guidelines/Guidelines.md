...
- Treat this mock as a design reference for `docs/design-s3-ui.md`; production implementation should stay in the Go-served dashboard unless the architecture decision changes.
