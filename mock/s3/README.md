...
This mock is a reference artifact only. The production dashboard should remain a Rust-served static HTML/CSS/JS implementation without a React runtime dependency unless that architectural decision is explicitly changed later.
...
- Do not port the mock dependency graph into `services/dashboard`.
