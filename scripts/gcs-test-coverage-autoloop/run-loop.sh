...
Current context:
- GCS service tests live in services/gcs/server_test.rs.
- GCS dashboard API tests live in services/dashboard/server_test.rs.
...
autocommit_if_requested() {
  ...
  git add .agents/orbit.md .gitignore services/gcs services/dashboard README.md docs scripts/gcs-e2e.sh scripts/gcs-autoloop/verify.sh scripts/gcs-dashboard-react-autoloop/verify.sh scripts/gcs-test-coverage-autoloop 2>/dev/null || true
