...
assert_dashboard_api_contract() {
  go test ./internal/dashboard -run 'TestRedshiftDashboardAPITableDetailAndQueryRunner|TestRedshiftDashboardAPIExposesBackendMode|TestRedshiftDashboardAPIExposesCatalogAndStatementMetadata' -count=1
}
