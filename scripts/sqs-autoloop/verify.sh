...
assert_sqs_config_shape() {
  env -u RIPGREP_CONFIG_PATH rg -q 'sqsPort|services\\.sqs|auth\\.sqs|SQS|sqs' internal cmd docs &&
    go test ./internal/app -run 'Test.*SQS|TestDefaultConfig|TestInitWorkspace|TestLoadConfig' -count=1
}
