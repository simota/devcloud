...
12. Existing Mail, S3, GCS, DynamoDB, BigQuery, SQS, and dashboard behavior remains compatible; `cargo test --workspace` passes.
...
- Prefer official `tonic-generated Pub/Sub protobuf service bindings` service interfaces for gRPC compatibility.
