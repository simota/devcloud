...
- Existing files: web/dashboard/src/app/services/dynamodb/{DynamoDBDashboard.tsx,api.ts,types.ts}, internal/dashboard/server.go, internal/dashboard/server_test.go, scripts/dynamodb-e2e.sh, README.md.
...
autocommit_if_requested() {
  ...
  git add .agents/orbit.md .gitignore internal/dashboard web/dashboard README.md docs scripts/dynamodb-e2e.sh scripts/dynamodb-dashboard-advanced-autoloop 2>/dev/null || true
