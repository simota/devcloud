...
The project needs a working MailHog-like local SMTP server before broader cloud emulator services are added. This loop should turn the Rust scaffold into a usable SMTP + dashboard/API MVP while preserving the documented static-dashboard direction.
