...
REDSHIFT_VERIFY_PORT="${REDSHIFT_VERIFY_PORT:-15439}"
REDSHIFT_API_VERIFY_PORT="${REDSHIFT_API_VERIFY_PORT:-19099}"
SQS_VERIFY_PORT="${SQS_VERIFY_PORT:-19324}"
PUBSUB_GRPC_VERIFY_PORT="${PUBSUB_GRPC_VERIFY_PORT:-18085}"
PUBSUB_REST_VERIFY_PORT="${PUBSUB_REST_VERIFY_PORT:-18086}"
...
assert_dynamodb_config_shape() {
  env -u RIPGREP_CONFIG_PATH rg -q 'dynamodbPort|services\\.dynamodb|auth\\.dynamodb|DynamoDB|dynamodb' rust docs &&
