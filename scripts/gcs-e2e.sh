...
Environment:
  ...
  E2E_MAIL_HTTP_PORT=11080    Override the Mail HTTP port used by devcloud. Defaults to an available port.
  ...
  E2E_APP_AUTOSCALING_PORT=18030 Override the Application Auto Scaling port. Defaults to an available port.
...
assert_dashboard_api() {
  ...
  # Compatibility /gcs must 301-redirect to /dashboard/gcs.
