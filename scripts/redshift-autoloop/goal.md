...
12. Existing Mail, S3, GCS, DynamoDB, BigQuery, SQS, Pub/Sub, and dashboard behavior remains compatible; `go test ./...` passes.
...
- Use Go standard library unless a PostgreSQL driver or process-management dependency is clearly justified.
