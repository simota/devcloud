...
- `sdk-client`: compatibility Storage client E2E contract.
...
The loop should converge by adding a deterministic local GCS SDK E2E path using `first-party Storage SDK` with endpoint override only.
