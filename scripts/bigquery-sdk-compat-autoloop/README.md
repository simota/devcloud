...
- `sdk-client`: compatibility BigQuery client E2E contract.
...
The loop should converge by adding a deterministic local BigQuery SDK E2E path using `first-party BigQuery SDK` with endpoint override only.
