...
Current context:
- S3 service tests live in services/s3/server_test.rs.
- S3 dashboard API tests live in services/dashboard/server_test.rs.
...
autocommit_if_requested() {
  ...
  git add .agents/orbit.md .gitignore services/s3 services/dashboard README.md docs scripts/s3-e2e.sh scripts/s3-autoloop/verify.sh scripts/s3-dashboard-management-autoloop/verify.sh scripts/s3-test-coverage-autoloop 2>/dev/null || true
