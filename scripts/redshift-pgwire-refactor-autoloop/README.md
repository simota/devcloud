...
This loop refactors `internal/services/redshift/pgwire.go` into smaller files without changing PostgreSQL wire protocol or Redshift behavior.
...
- `shape`: validates the refactored file layout and `pgwire.go` line budget.
