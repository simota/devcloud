//! Mirrors `internal/services/applicationautoscaling/sigv4.go`.
//!
//! AWS SigV4 verification with three modes (relaxed / signed-relaxed / strict),
//! matching the Go server's reply names and HTTP statuses exactly.
...
/// status the Go server would return.
#[derive(Debug, Clone)]
