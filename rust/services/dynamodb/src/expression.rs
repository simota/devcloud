...
//! expression_attributes}.go`. Update expressions (SET/REMOVE/ADD/DELETE) land
...
/// Go "condition check failed" error.
...
/// Go's `strings.Cut`: split on the first occurrence of `sep`.
