...
- Do not copy the mock's React dependency graph directly into the dashboard implementation.
- When Mail is ported to React, implement it under the common `web/dashboard` shell and keep the Rust dashboard serving embedded built assets at runtime.
