...
1. Go module and command skeleton: `cmd/devcloud`, `cmd/devcloudd`
...
| Risk | Mitigation |
| --- | --- |
| SMTP command parsing grows ad hoc | Keep session state machine isolated in `services/mail/smtp.go` |
