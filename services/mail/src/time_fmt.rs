...
//! legacy `time.Time` JSON marshaling — without pulling in a date crate.
//!
//! legacy marshals `time.Time` as RFC 3339 with fractional seconds only when
...
mod tests {
    ...
    fn formats_known_instants() {
        // 2026-04-30T10:00:00Z — matches the legacy golden oracle.
