//! Golden-oracle parity tests for the SQS MD5 hashing, captured from the legacy
...
// All expected digests below are captured from the legacy md5Hex /
// md5OfMessageAttributes for identical inputs (golden oracle).
#[test]
fn md5_hex_matches_legacy() {
...
#[test]
fn md5_of_message_attributes_single_string_matches_legacy() {
...
#[test]
fn md5_of_message_attributes_multi_sorted_matches_legacy() {
